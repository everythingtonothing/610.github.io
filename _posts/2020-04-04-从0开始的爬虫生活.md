...
3. **mysql数据库表中，删掉某些记录，怎么让新加的数据id连续（克服强迫症）**
...
4. **[Failure instance: Traceback: <class 'MySQLdb._exceptions.OperationalError'>: (1366, "Incorrect string value: '\\xF0\\x9F\\x99\\x8F</...' for column 'content' at row 1")**

   > 原因：文本有emoji符号， 而Mysql的utf-8编码最多3个字节，所以数据插不进去
   >
   > 解决方法： 
   >
